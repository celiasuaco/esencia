    ...
    return (
        <div className="min-h-screen bg-[#FDFBF9] py-12 px-6">
            <div className="max-w-5xl mx-auto">
                ...
                <button
                    onClick={() => navigate(-1)}
                    className="flex items-center gap-2 text-[#324339]/60 hover:text-[#324339] transition-colors text-[10px] uppercase tracking-widest mb-10"
                >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-12 lg:gap-20 items-start">
                    ...
                    <div className="space-y-6 w-full max-w-[350px] mx-auto lg:mx-0">
                        ...
                        {/* FOTO CON BORDE TERRACOTA */}
                        <div className="relative aspect-square flex justify-center items-center p-8 border border-[#A86447]/30 rounded-[2rem] bg-white/40 shadow-sm">
                            <div className="absolute top-4 left-4 w-4 h-4 border-t border-l border-[#A86447]/40 rounded-tl-lg"></div>
                            <div className="absolute bottom-4 right-4 w-4 h-4 border-b border-r border-[#A86447]/40 rounded-br-lg"></div>
                    ...
                    {/* lg:-mt-6 sube el bloque de texto para que el nombre quede por encima del inicio de la foto */}
                    <div className="space-y-8 lg:-mt-6 lg:pt-0">
                        <header className="space-y-2">
                            ...
                            <p className="text-2xl font-serif italic text-[#324339] pt-2">
                        ...
                        <div className="space-y-8 border-y border-[#324339]/10 py-10">
                            <div className="space-y-3">
                                ...
                                <p className="text-[#324339]/70 leading-relaxed text-[15px] font-light">
                                    {product.description}
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-8">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <p className="text-sm text-[#324339] pl-6">{product.material}</p>
                                </div>
                                <div className="flex flex-col gap-2">
                                    <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-sm text-[#324339] pl-6">Certificado Esencia</p>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Acción Principal */}
                        <div className="pt-4">
                            <button className="w-full py-5 bg-[#324339] text-white rounded-full flex items-center justify-center gap-3 hover:bg-[#25322a] transition-all font-bold uppercase text-[11px] tracking-[0.25em] shadow-xl shadow-[#324339]/10 group">
