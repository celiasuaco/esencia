        ...
        <div className="min-h-screen bg-[#FDFBF9] pt-6 md:pt-10 pb-20 px-4 md:px-6">
            <div className="max-w-5xl mx-auto">
                <header className="mb-8 md:mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                    <div>
                        <h1 className="text-3xl md:text-4xl font-serif text-[#324339] italic mb-2">Análisis de Clientes</h1>
                    </div>
                ...
                <div className="mb-8 flex items-center gap-3 px-4 md:px-6 py-4 bg-[#324339]/[0.02] rounded-2xl border border-[#324339]/5">
                    <Award className="text-[#A86447] flex-shrink-0" size={20} />
                    <span className="text-[10px] md:text-xs font-serif italic text-[#324339]/60 leading-tight">
                ...
                <div className="grid grid-cols-1 gap-4 md:gap-6">
                    {filteredClients.length > 0 ? (
                        ...
                        <div className="text-center py-20 bg-white rounded-[2rem] md:rounded-[3rem] border border-dashed border-[#324339]/10 px-4">
